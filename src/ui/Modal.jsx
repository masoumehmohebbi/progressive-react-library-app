  ...
  return (
    open && (
      <div className="w-full h-screen fixed top-0 left-0 backdrop-blur-sm bg-secondary-800 bg-opacity-30 z-50">
        <div
          ref={ref}
          className="fixed  overflow-y-scroll md:overflow-y-visible top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg bg-secondary-0 p-4 shadow-lg transition-all duration-300 ease-out w-[calc(100vw-2rem)] md:max-w-lg max-h-[calc(100vh-2rem)] overflow-y-4"
        >
